...
import { generateOtpCode, hashOtp, verifyOtpHash } from '../utils/otp.util';
...
export class OtpService {
  ...
  async sendOtp(dto: SendOtpDto, isResend: boolean = false) {
    ...
    const emailContent = getOtpEmailContent(rawCode, dto.type, isResend);
  ...
  async verifyOtp(dto: VerifyOtpDto) {
    ...
    const isMatch = verifyOtpHash(dto.code, otp.code);
    if (!isMatch) {
